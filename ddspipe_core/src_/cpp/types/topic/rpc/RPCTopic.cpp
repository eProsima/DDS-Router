...
RpcTopic::RpcTopic(
        ...
        const DistributedTopic& request_topic,
        const DistributedTopic& reply_topic) noexcept
...
const DistributedTopic& RpcTopic::request_topic() const
{
    return request_topic_;
}

const DistributedTopic& RpcTopic::reply_topic() const
{
    return reply_topic_;
}
