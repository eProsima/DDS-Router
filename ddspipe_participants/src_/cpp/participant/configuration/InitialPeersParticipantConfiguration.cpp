...
InitialPeersParticipantConfiguration::InitialPeersParticipantConfiguration(
        ...
        const std::set<Address>& connection_addresses,
        const TlsConfiguration& tls_configuration)
        ...
        utils::Formatter& error_msg) const noexcept
{
    ...
    if (tls_configuration.is_active())
    {
        ...
        {
            if (!tls_configuration.compatible<TlsKind::server>())
            {
        ...
        {
            if (!tls_configuration.compatible<TlsKind::client>())
            {
