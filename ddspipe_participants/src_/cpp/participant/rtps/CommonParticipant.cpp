...
#include <ddspipe_participants/participant/auxiliar/BaseParticipant.hpp>
        ...
        DiscoveryInfoKind& info)
{
    ...
    // Parse Topic
    core::types::DistributedTopic info_topic(std::string(info.info.topicName()), std::string(info.info.typeName()));
