        ...
        const DiscoveryServerParticipantConfiguration* configuration)
{
    ...
    for (core::types::Address address : configuration->listening_addresses)
    {
        if (!address.is_valid())
        {
    ...
    for (core::types::DiscoveryServerConnectionAddress connection_address : configuration->connection_addresses)
    {
        ...
        for (core::types::Address address : connection_address.addresses())
        {
            if (!address.is_valid())
            {
