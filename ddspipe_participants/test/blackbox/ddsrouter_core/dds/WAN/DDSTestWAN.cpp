...
std::shared_ptr<ParticipantConfiguration> discovery_server_participant_configuration(
        ...
        bool tls = false)
{
    ...
    if (tls)
    {
        return std::make_shared<DiscoveryServerParticipantConfiguration>(
...
std::shared_ptr<ParticipantConfiguration> initial_peers_participant_configuration(
        bool this_server_id_is_1,
        WanKind wan_kind,
        types::TransportProtocol transport_protocol,
        types::IpVersion ip_version,
        bool tls = false)
{
    ...
    if (tls)
    {
        return std::make_shared<InitialPeersParticipantConfiguration>(
...
std::shared_ptr<ParticipantConfiguration> wan_participant_configuration(
        ...
        types::DomainIdType domain)
{
    ...
    std::set<std::shared_ptr<types::DistributedTopic>> builtin_topics;   // empty
    ...
    std::set<std::shared_ptr<ParticipantConfiguration>> participants_configurations(
                    {
                        ...
                        // simple
                        std::make_shared<SimpleParticipantConfiguration>(
