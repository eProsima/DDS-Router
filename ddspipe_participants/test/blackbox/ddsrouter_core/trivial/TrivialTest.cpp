...
#include <ddspipe_participants/participant/auxiliar/DummyParticipant.hpp>
...
DdsRouterConfiguration void_configuration()
{
    DdsRouterConfiguration configuration;
    configuration.participants_configurations =
    {
        std::make_shared<ParticipantConfiguration>(
 ...
 */
DdsRouterConfiguration simple_configuration(
