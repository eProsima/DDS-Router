...
#ifndef __SRC_DDSROUTERCORE_EFFICIENCY_PAYLOAD_MAPPAYLOADPOOL_HPP_
#define __SRC_DDSROUTERCORE_EFFICIENCY_PAYLOAD_MAPPAYLOADPOOL_HPP_
...
#endif /* __SRC_DDSROUTERCORE_EFFICIENCY_PAYLOAD_MAPPAYLOADPOOL_HPP_ */
