...
#ifndef __SRC_DDSROUTERCORE_EFFICIENCY_PAYLOAD_PAYLOADPOOL_HPP_
#define __SRC_DDSROUTERCORE_EFFICIENCY_PAYLOAD_PAYLOADPOOL_HPP_
...
#endif /* __SRC_DDSROUTERCORE_EFFICIENCY_PAYLOAD_PAYLOADPOOL_HPP_ */
