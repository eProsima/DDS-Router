 ...
 */
class BaseParticipant : public core::IParticipant
{
...
protected:
     ...
     * @return Writer
     */
    virtual std::shared_ptr<core::IWriter> create_writer_(
            core::types::DdsTopic topic) = 0;
     ...
     * @return Reader
     */
    virtual std::shared_ptr<core::IReader> create_reader_(
            core::types::DdsTopic topic) = 0;
     ...
     */
    core::types::ParticipantId id_nts_() const noexcept;
    ...
    std::map<core::types::DdsTopic, std::shared_ptr<core::IWriter>> writers_;

    //! Readers created by this Participant indexed by topic
    std::map<core::types::DdsTopic, std::shared_ptr<core::IReader>> readers_;
