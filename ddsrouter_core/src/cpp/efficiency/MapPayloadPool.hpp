...
#ifndef __SRC_DDSROUTERCORE_EFFICIENCY_MAPPAYLOADPOOL_HPP_
#define __SRC_DDSROUTERCORE_EFFICIENCY_MAPPAYLOADPOOL_HPP_
...
#endif /* __SRC_DDSROUTERCORE_EFFICIENCY_MAPPAYLOADPOOL_HPP_ */
