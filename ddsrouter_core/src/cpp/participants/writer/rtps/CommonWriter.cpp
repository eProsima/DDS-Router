...
#include <ddsrouter_core/participants/writer/rtps/CommonWriter.hpp>
#include <ddsrouter_core/participants/writer/rtps/filter/RepeaterDataFilter.hpp>
#include <ddsrouter_core/participants/writer/rtps/filter/SelfDataFilter.hpp>
...
using eprosima::ddsrouter::core::types::operator<<;
