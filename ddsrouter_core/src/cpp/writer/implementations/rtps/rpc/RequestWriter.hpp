...
#ifndef __SRC_DDSROUTERCORE_WRITER_IMPLEMENTATIONS_RTPS_RPC_REQUESTWRITER_HPP_
#define __SRC_DDSROUTERCORE_WRITER_IMPLEMENTATIONS_RTPS_RPC_REQUESTWRITER_HPP_
...
#endif /* __SRC_DDSROUTERCORE_WRITER_IMPLEMENTATIONS_RTPS_RPC_REQUESTWRITER_HPP_ */
