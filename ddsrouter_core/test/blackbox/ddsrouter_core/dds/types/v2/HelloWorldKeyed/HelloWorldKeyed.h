...
#include "HelloWorldKeyedv1.h"

#if FASTCDR_VERSION_MAJOR > 1

#ifndef _FAST_DDS_GENERATED_HELLOWORLDKEYED_H_
#define _FAST_DDS_GENERATED_HELLOWORLDKEYED_H_
...
#endif // _FAST_DDS_GENERATED_HELLOWORLDKEYED_H_
