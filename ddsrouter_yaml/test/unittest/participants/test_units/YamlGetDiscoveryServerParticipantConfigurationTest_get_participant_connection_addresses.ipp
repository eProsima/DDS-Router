...
TEST(YamlGetDiscoveryServerParticipantConfigurationTest, get_participant_connection_addresses)
{
    ...
    // 1 connection N addresses
    {
        ...
        for (participants::types::Address address : addresses)
        {
            ...
            std::set<eprosima::ddsrouter::participants::types::Address> addresses_result =
    ...
    // N connections 1 address
    {
        ...
        for (participants::types::DiscoveryServerConnectionAddress connection : result.connection_addresses)
        {
            ASSERT_NE(
