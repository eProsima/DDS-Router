...
TEST(YamlGetDiscoveryServerParticipantConfigurationTest, tls_configuration_inactive)
{
    ...
    // Check tls_configuration
    ASSERT_FALSE(ds_participant_cfg.tls_configuration_.compatible<core::types::security::TlsKind::client>());
    ASSERT_FALSE(ds_participant_cfg.tls_configuration_.compatible<core::types::security::TlsKind::both>());
    ASSERT_FALSE(ds_participant_cfg.tls_configuration_.compatible<core::types::security::TlsKind::server>());
    ASSERT_FALSE(ds_participant_cfg.tls_configuration_.is_active());

    ASSERT_THROW(ds_participant_cfg.tls_configuration_.certificate_authority_file(), utils::InconsistencyException);
    ASSERT_THROW(ds_participant_cfg.tls_configuration_.private_key_file_password(), utils::InconsistencyException);
    ASSERT_THROW(ds_participant_cfg.tls_configuration_.private_key_file(), utils::InconsistencyException);
    ASSERT_THROW(ds_participant_cfg.tls_configuration_.certificate_chain_file(), utils::InconsistencyException);
    ASSERT_THROW(ds_participant_cfg.tls_configuration_.dh_params_file(), utils::InconsistencyException);
}
