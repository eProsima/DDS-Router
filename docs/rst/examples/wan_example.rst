...
``<path/to/ddsrouter>/resources/configurations/examples/wan_client.yaml``
...
Execute |ddsrouter| using file ``<path/to/ddsrouter>/resources/configurations/examples/wan_server.yaml``.
...
Execute |ddsrouter| using file ``<path/to/ddsrouter>/resources/configurations/examples/wan_client.yaml``.
