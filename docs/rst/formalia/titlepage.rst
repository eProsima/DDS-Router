...
Following are some of the key features of *eProsima DDS Router*:
  ...
  7. **Quality of Service preservation**: the DDS Router uses the QoS set by the DDS user network and keeps the
     reliability and durability of the communication set for each topic. This QoS are also manually configurable.
