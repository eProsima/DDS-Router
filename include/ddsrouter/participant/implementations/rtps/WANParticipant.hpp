...
class WANParticipant
    : public DiscoveryServerParticipant<configuration::WanParticipantConfiguration>
{
public:

    WANParticipant(
            std::shared_ptr<configuration::WanParticipantConfiguration> participant_configuration,
