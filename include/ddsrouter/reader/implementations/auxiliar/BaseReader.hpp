...
#ifndef _DDSROUTER_READER_IMPLEMENTATIONS_AUX_BASEREADER_HPP_
#define _DDSROUTER_READER_IMPLEMENTATIONS_AUX_BASEREADER_HPP_
...
#endif /* _DDSROUTER_READER_IMPLEMENTATIONS_AUX_BASEREADER_HPP_ */
