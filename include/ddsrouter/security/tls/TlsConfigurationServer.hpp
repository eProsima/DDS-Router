...
#ifndef _DDSROUTER_SECURITY_TLS_TLSCONFIGURATIONSERVER_HPP_
#define _DDSROUTER_SECURITY_TLS_TLSCONFIGURATIONSERVER_HPP_
...
#endif /* _DDSROUTER_SECURITY_TLS_TLSCONFIGURATIONSERVER_HPP_ */
