...
protected:
    ...
    static const PortType DEFAULT_PORT;                         // 11666
    static const IpType DEFAULT_IP;                             // 127.0.0.1
    static const IpVersion DEFAULT_IP_VERSION;                  // IPv4
    static const TransportProtocol DEFAULT_TRANSPORT_PROTOCOL;  // UDP
};
