        ...
        Payload& target_payload)
{
    ...
    else
    {
        ...
        if (payload_it == reserved_payloads_.end())
        {
            ...
            throw InconsistencyException("Payload ownership is this pool, but it is not reserved from here.");
        }
        ...
        Payload& payload)
{
    ...
    if (payload_it == reserved_payloads_.end())
    {
        ...
        throw InconsistencyException("Trying to release a payload from this pool that is not present.");
    }
