...
TEST(YamlGetDiscoveryServerParticipantConfigurationTest, get_participant_connection_addresses)
{
    ...
    // 1 address
    {
        ...
        // Add address
        Address address = eprosima::ddsrouter::test::random_address();
        ...
        // Add server guid
        GuidPrefix connection_guid = eprosima::ddsrouter::test::random_guid_prefix();
    ...
    // N connections 1 address
    {
        ...
        for (int i = 0; i < eprosima::ddsrouter::test::TEST_NUMBER_ITERATIONS; i++)
        {
            ...
            // Add server guid
            GuidPrefix connection_guid = eprosima::ddsrouter::test::random_guid_prefix(i);
        ...
        for (DiscoveryServerConnectionAddress connection : result.connection_addresses())
        {
            ASSERT_NE(
