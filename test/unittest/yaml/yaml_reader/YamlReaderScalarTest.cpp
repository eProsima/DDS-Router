...
TEST(YamlReaderScalarTest, get_scalar_bool)
{
    ...
    {
        Yaml yml(0);
        ASSERT_THROW(test::MockYamlReader::get_scalar<bool>(yml), ConfigurationException);
    }
}
...
TEST(YamlReaderScalarTest, get_scalar_int)
{
    ...
    // fail with bool
    {
        ASSERT_THROW(test::MockYamlReader::get_scalar<int>(Yaml(false)), ConfigurationException);
    }
}
...
TEST(YamlReaderScalarTest, get_scalar_from_tag)
{
    ...
    // no tag
    {
        Yaml yml;
        yml["other_tag"] = 3;
        ASSERT_THROW(test::MockYamlReader::get_scalar<int>(yml, tag), ConfigurationException);
    }
}
...
TEST(YamlReaderScalarTest, get_scalar_negative_cases)
{
    // null
    {
        ...
        ASSERT_THROW(test::MockYamlReader::get_scalar<int>(yml), ConfigurationException);
    }
